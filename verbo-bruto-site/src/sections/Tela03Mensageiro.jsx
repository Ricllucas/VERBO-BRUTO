...
export default function Tela03Mensageiro() {
  return (
    <section className="relative min-h-screen w-full bg-[#0A0A0A] py-28 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <ScrollReveal className="mb-16">
          <div className="relative overflow-hidden">
            <img
              ...
              alt="O Mensageiro"
              className="w-full h-[60vh] md:h-[80vh] object-cover object-top opacity-80"
              loading="lazy"
            />
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <ScrollReveal delay={0.1}>
            <h2
              className="font-['Oswald'] font-bold uppercase text-[#F5F5F5] leading-tight mb-10"
