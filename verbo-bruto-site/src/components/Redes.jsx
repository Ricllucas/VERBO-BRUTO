    ...
    <section id="redes" className="bg-[#0D0D0D] py-28 px-6">
      ...
      >
        ...
        <motion.p variants={fadeUp} className="text-[#888888] text-base leading-relaxed max-w-lg mb-14">
          ...
          Escolha por onde começar — mas não pare por aí.
        </motion.p>
        ...
        <motion.div
          variants={fadeUp}
          className="mt-16 bg-[#111111] border border-[#D4AF37]/10 p-8 md:p-10 text-center"
        >
          <p className="font-['Oswald'] font-bold uppercase text-[#F5F5F5] text-xl md:text-2xl tracking-wider mb-4">
            A jornada não termina aqui
          </p>
          <p className="text-[#888888] text-sm leading-relaxed max-w-md mx-auto mb-8">
            Cada música é uma porta. Cada vídeo é um convite. E cada dia que passa,
            mais conteúdo é liberado para quem decide caminhar junto.
          </p>
